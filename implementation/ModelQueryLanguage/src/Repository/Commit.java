...
public interface Commit extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Modified Models</b></em>' containment reference list.
	 * The list contents are of type {@link Repository.ModelModif}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Modified Models</em>' containment reference list.
	 * @see Repository.RepositoryPackage#getCommit_ModifiedModels()
	 * @model containment="true" required="true"
	 * @generated
	 */
	EList<ModelModif> getModifiedModels();
