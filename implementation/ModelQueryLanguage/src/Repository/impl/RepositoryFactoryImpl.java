...
public class RepositoryFactoryImpl extends EFactoryImpl implements RepositoryFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case RepositoryPackage.PARENT: return createParent();
			case RepositoryPackage.HEAD: return createHead();
			case RepositoryPackage.NEXT: return createNext();
			case RepositoryPackage.CURRENT_MODEL: return createCurrentModel();
			case RepositoryPackage.MAIN_BRANCH: return createMainBranch();
			case RepositoryPackage.GENERIC_BRANCH: return createGenericBranch();
			...
			case RepositoryPackage.MODEL_MODIF: return createModelModif();
	 ...
	 */
	@Override
	public CurrentModel createCurrentModel() {
		CurrentModelImpl currentModel = new CurrentModelImpl();
		return currentModel;
	}
	 ...
	 */
	@Override
	public GenericBranch createGenericBranch() {
		GenericBranchImpl genericBranch = new GenericBranchImpl();
		return genericBranch;
	}
	 ...
	 */
	@Override
	public ModelModif createModelModif() {
		ModelModifImpl modelModif = new ModelModifImpl();
		return modelModif;
	}
