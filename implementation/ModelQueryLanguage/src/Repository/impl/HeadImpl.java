 ...
 * </p>
 * <ul>
 *   <li>{@link Repository.impl.HeadImpl#getName <em>Name</em>}</li>
 *   <li>{@link Repository.impl.HeadImpl#getBranch <em>Branch</em>}</li>
 *   <li>{@link Repository.impl.HeadImpl#getCommit <em>Commit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HeadImpl extends EObjectImpl implements Head {
	...
	protected EClass eStaticClass() {
		return RepositoryPackage.Literals.HEAD;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.HEAD__NAME, oldName, name));
	}
	...
	public Branch getBranch() {
		if (branch != null && branch.eIsProxy()) {
			...
			if (branch != oldBranch) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RepositoryPackage.HEAD__BRANCH, oldBranch, branch));
			}
		}
		return branch;
	}
	...
	public void setBranch(Branch newBranch) {
		...
		branch = newBranch;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.HEAD__BRANCH, oldBranch, branch));
	}
	...
	public Commit getCommit() {
		if (commit != null && commit.eIsProxy()) {
			...
			if (commit != oldCommit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RepositoryPackage.HEAD__COMMIT, oldCommit, commit));
			}
		}
		return commit;
	}
	...
	public void setCommit(Commit newCommit) {
		...
		commit = newCommit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RepositoryPackage.HEAD__COMMIT, oldCommit, commit));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RepositoryPackage.HEAD__NAME:
				return getName();
			case RepositoryPackage.HEAD__BRANCH:
				if (resolve) return getBranch();
				return basicGetBranch();
			case RepositoryPackage.HEAD__COMMIT:
