...
public class ModelQueryLanguageFactoryImpl extends EFactoryImpl implements ModelQueryLanguageFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ModelQueryLanguagePackage.QUERY_FILE: return createQueryFile();
			case ModelQueryLanguagePackage.MODEL_QUERY: return createModelQuery();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case ModelQueryLanguagePackage.OPERATOR:
	...
	public QueryFile createQueryFile() {
		QueryFileImpl queryFile = new QueryFileImpl();
		return queryFile;
	}
