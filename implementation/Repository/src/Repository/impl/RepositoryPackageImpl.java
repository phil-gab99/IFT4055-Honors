...
public class RepositoryPackageImpl extends EPackageImpl implements RepositoryPackage {
	 ...
	 */
	@Override
	public EAttribute getBranch_Active() {
	 ...
	 */
	@Override
	public EReference getBranch_Parent() {
	 ...
	 */
	@Override
	public EReference getBranch_Head() {
	 ...
	 */
	@Override
	public EReference getCommit_Next() {
	 ...
	 */
	@Override
	public EReference getModel_Current() {
	 ...
	 */
	@Override
	public EAttribute getModelSnapshot_Name() {
	...
	public EAttribute getModelSnapshot_Path() {
		return (EAttribute)modelSnapshotEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getModelSnapshot_DiffModified() {
		return (EAttribute)modelSnapshotEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getModelSnapshot_DiffCreated() {
		return (EAttribute)modelSnapshotEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getModelSnapshot_DiffDeleted() {
		return (EAttribute)modelSnapshotEClass.getEStructuralFeatures().get(4);
	}
	...
	public EReference getModelSnapshot_Next() {
		return (EReference)modelSnapshotEClass.getEStructuralFeatures().get(5);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(branchEClass, BRANCH__ACTIVE);
		createEReference(branchEClass, BRANCH__COMMITS);
		createEReference(branchEClass, BRANCH__PARENT);
		createEReference(branchEClass, BRANCH__HEAD);
		...
		createEReference(commitEClass, COMMIT__NEXT);
		...
		createEReference(modelEClass, MODEL__CURRENT);
		createEReference(modelEClass, MODEL__LIFETIME);

		modelSnapshotEClass = createEClass(MODEL_SNAPSHOT);
		createEAttribute(modelSnapshotEClass, MODEL_SNAPSHOT__NAME);
		createEAttribute(modelSnapshotEClass, MODEL_SNAPSHOT__PATH);
		createEAttribute(modelSnapshotEClass, MODEL_SNAPSHOT__DIFF_MODIFIED);
		createEAttribute(modelSnapshotEClass, MODEL_SNAPSHOT__DIFF_CREATED);
		createEAttribute(modelSnapshotEClass, MODEL_SNAPSHOT__DIFF_DELETED);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRepo_Name(), ecorePackage.getEString(), "name", null, 0, 1, Repo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getRepo_Branches(), this.getBranch(), null, "branches", null, 1, -1, Repo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getBranch_Active(), ecorePackage.getEBooleanObject(), "active", null, 0, 1, Branch.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBranch_Parent(), this.getCommit(), null, "parent", null, 1, 1, Branch.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBranch_Head(), this.getCommit(), null, "head", null, 1, 1, Branch.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCommit_Next(), this.getCommit(), null, "next", null, 0, 1, Commit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCommit_ModifiedModels(), this.getModelSnapshot(), null, "modifiedModels", null, 1, -1, Commit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getModel_Current(), this.getModelSnapshot(), null, "current", null, 1, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getModelSnapshot_Name(), ecorePackage.getEString(), "name", null, 0, 1, ModelSnapshot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getModelSnapshot_DiffModified(), ecorePackage.getEString(), "diffModified", null, 0, -1, ModelSnapshot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getModelSnapshot_DiffCreated(), ecorePackage.getEString(), "diffCreated", null, 0, -1, ModelSnapshot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getModelSnapshot_DiffDeleted(), ecorePackage.getEString(), "diffDeleted", null, 0, -1, ModelSnapshot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
